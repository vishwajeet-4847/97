...
const ProfileUser = ({ profileData }) => {
  ...
  return (
    <div className="bg-white w-full">
      ...
      {commissionPopup && <CommissionModal onClose={onClose} user_id={profile.fs_id} setProfile={setProfile} setCommissionPopup={setCommissionPopup}/>}

      {rollingCommissionPopup && <RollingCommissionModal onClose={onClose} user_id={profile.fs_id} setProfile={setProfile} setRollingCommissionPopup={setRollingCommissionPopup}/>}
      
      {passwordPopup &&  <PasswordModal onClose={onClose} user_id={profile.fs_id} setProfile={setProfile} setPasswordPopup={setPasswordPopup}/>}

      {mobilePopup && <MobileModal onClose={onClose} user_id={profile.fs_id} setProfile={setProfile} setMobilePopup={setMobilePopup}/>}
